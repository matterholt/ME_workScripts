# -*- coding: utf-8 -*-
"""
Created on Mon Jun  8 10:01:22 2020
...
def total_files_size_year(data,year_range_file):
    ...
    for year in year_range_file:
        ...
        file_count = 0
        for entry in data:
            if entry['size'] != 'unknown' or entry['year'] !='unknown':
...
def ploted_data(data):
    ...
    count = list(map(lambda x: x['total_file'],organize_byYear_size_count))
...
file =r"C:\Users\matterholt\Documents\00_coding\python_cleanDirs\ME_workScripts-master\digital_waste\file_eval_save-full.json"
data_file = file
