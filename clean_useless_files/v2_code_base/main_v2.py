...
def search_dir(dir_path, inputs_bond):
        ...
        for file_name in files:
            ...
            try:
                ...
                for extensions in inputs_bond["extension_no_need"]:
                    """ 
                    Reviews the file extension, if found in list will
                     documentspecs and proceed to remove from the directory
                    """
    ...
    search_info.update(GB_size=round(
        accumulated_file_size/1000000000, 2))  # convert to GB
